...
const TOOL_LABELS: Record<string, string> = {
  ...
  make_call: 'Llamar',
  read_call_log: 'Registro llamadas',
  read_contacts: 'Contactos',
  launch_app: 'Abrir app',
  list_apps: 'Lista apps',
  read_screen: 'Leer pantalla',
  click_text: 'Clic texto',
  click_at: 'Clic coordenada',
  type_text: 'Escribir texto',
  swipe: 'Deslizar',
  press_back: 'Atras',
  press_home: 'Inicio',
  read_notifications: 'Notificaciones',
  dismiss_notification: 'Descartar notif.',
  clipboard_read: 'Leer portapapeles',
  clipboard_write: 'Copiar portapapeles',
